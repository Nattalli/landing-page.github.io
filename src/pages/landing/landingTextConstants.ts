// first block
export const aboutUs = `«Саша шукає відповіді» – ВСЕУКРАЇНСЬКИЙ УРОК-ОПИТУВАННЯ. ЙОГО 
...
export const textFormThird = `Детальніше – в плані уроку, який ви отримаєте на пошту 
